...
$cnfig = mysqli_connect("localhost" , "root" , "" , "login2") ;
...
if (isset($_POST['btn'])){
  ...
  $query = "INSERT INTO login (email , 	pass ,fullname) VALUE  ('$email' , '$pass' , '$name')" ;
  mysqli_query($cnfig , $query) ;
                    ...
                    <div class="form-items">
                        ...
                        <form method="post">
                            ...
                            <div class="form-button">
                                <button id="submit" type="submit" class="ibtn" name="btn">Register</button>
                            </div>
                        </form>
